...
public class FlinkUserCodeClassLoader extends URLClassLoader {
	...
	private static Logger log = LoggerFactory.getLogger(FlinkUserCodeClassLoader.class);
	...
	public FlinkUserCodeClassLoader(URL[] urls, ClassLoader parent, URLStreamHandlerFactory factory) {
